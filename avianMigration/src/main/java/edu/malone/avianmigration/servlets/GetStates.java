 ...
 * @author lmmuriuki1
 */
@WebServlet(name = "GetStates", urlPatterns = {"/GetStates"})
public class GetStates extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Table st = Access.getInstance().getTable("SELECT DISTINCT [STATE] FROM [NSFCourter2016].[dbo].[MAIN_VIEW] ", new Object[]{}, "project");
            ...
            while(st.next())
            {
                statesArray.put(st.getString("STATE"));
            }

            states.put("States", statesArray);

            out.write(statesArray.toString());
