 ...
 * @author lmmuriuki1
 */
@WebServlet(name = "GetHistVariableNames", urlPatterns = {"/GetHistVariableNames"})
public class GetHistVariableNames extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Get simply the first row of the view.
                Table columnNames = Access.getInstance().getTable("SELECT TOP(1) * FROM NSFCourter2016.dbo.HISTORICAL_VIEW", new Object[]{}, "project");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetHistVariableNames.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
