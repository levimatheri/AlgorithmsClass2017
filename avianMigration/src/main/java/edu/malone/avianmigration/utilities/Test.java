...
//
//            HttpGet request = new HttpGet("https://www.ncdc.noaa.gov/cdo-web/api/v2/data?datasetid=GSOY&datatypeid=PRCP&locationid=FIPS:01&startdate=2005-01-01&enddate=2005-02-01&limit=1000");
//            HttpGet request = new HttpGet("https://www.ncdc.noaa.gov/cdo-web/api/v2/datacategories?datasetid=GHCND");
//             add request header
